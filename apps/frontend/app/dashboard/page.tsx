    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-violet-200/60 bg-gradient-to-br from-violet-600 via-indigo-600 to-cyan-600 p-6 text-white shadow-xl shadow-violet-500/15 sm:p-8">
        ...
        <div className="relative">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.22em] text-violet-100">Tu espacio cognitivo</p>
          <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Hola, sigue avanzando a tu ritmo</h1>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <section aria-labelledby="tasks-heading" className="lg:col-span-7">
          ...
          >
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-300"><ListTodo className="h-4 w-4" /></span>
            Tareas activas
          </h2>
          <TaskList />
        </section>
        ...
        <section id="micro-objectives" aria-labelledby="mo-heading" className="scroll-mt-20 lg:col-span-5">
          <h2
            id="mo-heading"
            className="mb-4 flex items-center gap-2 text-base font-semibold"
          >
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300"><CheckCircle2 className="h-4 w-4" /></span>
            Micro-objetivos
          </h2>
        ...
        <section aria-labelledby="fatigue-heading" className="lg:col-span-12">
          <h2
            ...
            className="mb-4 flex items-center gap-2 text-base font-semibold"
          >
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-cyan-100 text-cyan-700 dark:bg-cyan-500/15 dark:text-cyan-300"><Activity className="h-4 w-4" /></span>
            Historial de fatiga
          </h2>
          <FatigueHistoryChart />
        </section>
